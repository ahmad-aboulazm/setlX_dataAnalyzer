...
\section{Sample Run}
In short, \textsc{setlX} is an untyped language and type errors in it are only caught at run time. However, after the implementation of this analyzer, errors can actually be caught before run time. To be specific, the analyzer successfully covers the following checks:
\begin{enumerate}
